...
@protocol NotificationViewControllerReceiver;

SWIFT_CLASS("_TtC8REIOSSDK31NotificationInboxViewController")
@interface NotificationInboxViewController : UIViewController <UNUserNotificationCenterDelegate>
@property (nonatomic, strong) id <NotificationViewControllerReceiver> _Nullable notificationDelegate;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
@interface NotificationInboxViewController (SWIFT_EXTENSION(REIOSSDK)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_PROTOCOL("_TtP8REIOSSDK34NotificationViewControllerReceiver_")
@protocol NotificationViewControllerReceiver
...
@interface RSInboxViewcontroller : UIViewController <UISearchBarDelegate, UISearchResultsUpdating, UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC8REIOSSDK22RSPlayerViewController")
@interface RSPlayerViewController : AVPlayerViewController
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (void)viewWillDisappear:(BOOL)animated;
