...
RCT_EXPORT_METHOD(getNotification:(RCTResponseSenderBlock)callback) {
  ...
  dispatch_sync(dispatch_get_main_queue(), ^{
    ...
    RSInboxViewcontroller *inbox = [[RSInboxViewcontroller alloc]init];
    [topController addChildViewController:inbox];
    inbox.view.bounds = [topController view].bounds;
    [[topController view]addSubview:[inbox view]];
    [inbox didMoveToParentViewController:topController];
  });
